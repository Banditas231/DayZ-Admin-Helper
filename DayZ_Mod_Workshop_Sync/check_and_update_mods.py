#!/usr/bin/env python3
# DayZ Mod Workshop Sync — MIT. Full license text on GitHub.
...
Copyright (c) 2026 Kestas / Banditas.
Licensed under the MIT License (see the project repository on GitHub).
"""
...
# Startup banner text is not stored as one plain line (reduces drive-by edits). Legal notice remains in the
# module docstring above. Removing or falsifying attribution may violate the MIT License.
_ATR_A = "Q29weXJpZ2h0IChjKSAyMDI2IEtlc3RhcyAvIEJhbmRpdGFzIC0g"
_ATR_B = "TUlUIExpY2Vuc2UgKHNlZSBwcm9qZWN0IG9uIEdpdEh1Yik="


def _startup_credit_line() -> str:
    return base64.b64decode(_ATR_A).decode("utf-8") + base64.b64decode(_ATR_B).decode("utf-8")
