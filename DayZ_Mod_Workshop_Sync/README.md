...
**Please keep `LICENSE` in the zip** and do not claim you wrote the original tool.

## Author & license

- **Who made it:** the copyright holder is named in **`LICENSE`** (if you are the author, replace `[YOUR NAME OR HANDLE — edit this line]` there once before you publish the zip).
- **Terms:** read **`LICENSE`** — free use and sharing with **attribution**; **no selling** this as your own product without permission; **no removing** copyright / pretending to be the author.

This is a practical community notice (not a substitute for legal advice in your country).
